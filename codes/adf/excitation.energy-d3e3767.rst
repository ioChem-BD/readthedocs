...
.. table:: Template attributes
   ...
   +-----------------------------------+-----------------------------------+
   | pattern                           | .*EXCITAT                         |
   |                                   | ION\sENERGY\sCALCULATION,\sa\spar |
   |                                   | t\sof\sthe\sADF-RESPONSE\scode.\* |
   +-----------------------------------+-----------------------------------+
   | endPattern                        | \\s*Normal\stermination\          |
   |                                   | sof\sEXCITATION\sprogram\spart.\* |
   +-----------------------------------+-----------------------------------+
   | offset                            | -2                                |
   +-----------------------------------+-----------------------------------+
   | endOffset                         | 1                                 |
   ...
   | repeat                            | \*                                |
   +-----------------------------------+-----------------------------------+
   | xml:base                          | results/excit                     |
   |                                   | ationenergy/excitation.energy.xml |
   +-----------------------------------+-----------------------------------+
