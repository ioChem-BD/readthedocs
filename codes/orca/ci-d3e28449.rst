...
.. toctree::
   ...
   /codes/orca/coupledClusterEnergy-d3e28456
   /codes/orca/rhfTriplesCorr-d3e28489
   /codes/orca/triplesCorr-d3e28538
...
.. table:: Template attributes
   ...
   | id                                | ci                                |
   +-----------------------------------+-----------------------------------+
   | name                              | Orca-matrix driven Configuration  |
   |                                   | Interaction                       |
   +-----------------------------------+-----------------------------------+
   | pattern                           | \\s*-{70,}\s*$\s*ORCA-MA          |
   |                                   | TRIX\sDRIVEN\sCI\s*$\s*-{70,}\s\* |
   +-----------------------------------+-----------------------------------+
   | endPattern                        | \\s*-{                            |
   |                                   | 70,}\s*$\s*((?!ORCA-MATRIX\sDRIVE |
   |                                   | N\sCI|.*ORBITAL.*|.*COUPLED\sCLUS |
   |                                   | TER\sITERATIONS).)*$\s*-{70,}\s\* |
   +-----------------------------------+-----------------------------------+
   | endPattern2                       | ~                                 |
   +-----------------------------------+-----------------------------------+
   | endOffset                         | 0                                 |
...
.. code:: xml
   ...
   <templateList>  <xi:include href="coupledcluster.xml" />  <xi:include href="rhftriplescorr.xml" />  <xi:include href="triplescorr.xml" />
       </templateList>
