...
.. toctree::
   ...
   /codes/turbomole/populations-d3e32690
   /codes/turbomole/spin.density-d3e32871
...
.. table:: Template attributes
   ...
   +-----------------------------------+-----------------------------------+
   | pattern                           | \\s*={10,}\s*$\s*(MULLIK          |
   |                                   | EN|LOEWDIN|NATURAL)\sPOPULATION\s |
   |                                   | ANALYSIS\s*\(.*\).*$\s*={10,}\s\* |
   +-----------------------------------+-----------------------------------+
   ...
   +-----------------------------------+-----------------------------------+
   | xml:base                          | p                                 |
   |                                   | opulation/population.analysis.xml |
   +-----------------------------------+-----------------------------------+
